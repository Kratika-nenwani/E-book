...
public class AddBook extends HttpServlet {
    ...
    String fileName=part.getSubmittedFileName();
        ...
        sc.executeUpdate("insert into book_details(bookName,author,price,bookCategory,status,photo) values('" + bookName + "','" + author + "','" + price + "','" + bookCategory + "','"+bookStatus+"','"+fileName+"')");
